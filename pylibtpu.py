...
verify("upload", transfer_ev1 := driver_fn.TpuDriver_TransferToDevice(driver, a_src, buf_a_handle, 1, allocate_buf_a_events))
...
verify("upload", transfer_ev2 := driver_fn.TpuDriver_TransferToDevice(driver, b_src, buf_b_handle, 1, allocate_buf_b_events))
